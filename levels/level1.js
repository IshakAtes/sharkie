const level1 = new Level(
    ...
    [
        ...
        new Water('./img/3. Background/Layers/5. Water/L1.png', -2),
        new Water('./img/3. Background/Layers/5. Water/L2.png', 1020),
        new Water('./img/3. Background/Layers/5. Water/L1.png', 2042),
        new Water('./img/3. Background/Layers/5. Water/L2.png', 3064),
        new Water('./img/3. Background/Layers/5. Water/L1.png', 4086),
        new Water('./img/3. Background/Layers/5. Water/L2.png', 5108),
        new Water('./img/3. Background/Layers/5. Water/L1.png', 6130),
        new Water('./img/3. Background/Layers/5. Water/L2.png', 7152),
        new Water('./img/3. Background/Layers/5. Water/L1.png', 8174),
        new Water('./img/3. Background/Layers/5. Water/L2.png', 9196),
        new Water('./img/3. Background/Layers/5. Water/L1.png', 10218),
        new Water('./img/3. Background/Layers/5. Water/L2.png', 11240),
    ],
    [
